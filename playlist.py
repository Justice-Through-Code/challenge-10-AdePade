...
'''
add_song(my_playlist, {'artist': 'Kanye West', 'title': 'Ultralight Beam'})
...
add_song(my_playlist, {'artist': 'Lil Wayne', 'title': 'Fire Man'})
add_song(my_playlist, {'artist': '2pac', 'title': 'Big Poppa'})
